                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="country_id" name="country" required
                                       value="{{ $seller->country->name }}" readonly autofocus tabindex="2">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email" required
                                       value="{{ $seller->email }}" readonly autofocus tabindex="3">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="company_name" name="company_name" required
                                       value="{{ $seller->company_name }}" readonly autofocus tabindex="4">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="website" name="website" required
                                       value="{{ $seller->website }}" readonly autofocus tabindex="5">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="source" name="source" required
                                       value="{{ $seller->source }}" readonly autofocus tabindex="6">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="bio" class="form-label">{{ __('seller::seller.bio') }}</label>
                                <textarea class="form-control" id="bio" rows="4" name="bio" tabindex="7"
